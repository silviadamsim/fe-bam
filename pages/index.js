  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-scren py-2 bg-gray-100">
      <Head>
        ...
        <link rel="icon" href="../public/assets/projects/logo uhamka.png"></link>
      </Head>
        ...
        <div className="bg-white rounded-2xl shadow 2xl flex w-2/3 max-w-4xl">
          <div className="w-3/5 p-5">
            <div className="text-left font-bold">
              <span className="text-[#192f59]">BAITUL ARQAM PURNA STUDI<br></br></span>UHAMKA
            </div>
            <div className="py-10">
              ...
              <div className="flex flex-col items-center">
                <div className="bg-gray-100 w-64 p-2 flex items-center">
                  ...
                  <a href="#" className="border-2 border-[#192f59] text-[#192f59] rounded-full px-12 py-2 inline-block font-semibold hover:bg-[#192f59]  hover:text-white">
                    Sign In
                  </a>
              </div>
            </div>
          ...
          {/* Sign In section */}
      <div className="w-2/5 bg-[#192f59] text-white rounded-tr-2xl rounded-br-2xl py-36 px-12">
          <h2 className="text-3xl font-bold mb-2">Assalamualaikum Sobat UHAMKA!</h2>
